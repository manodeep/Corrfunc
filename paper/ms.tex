...
correlation function is not a bottle-neck, modeling the observed galaxy distribution correctly
...
\acknowledgments MS acknowledges the fantastic \texttt{largemem} nodes with 1 TB of RAM at Stampede (TACC) without which the project could not have been done. 
This work has been supported by the NSF Career Award (AST-1151650).
