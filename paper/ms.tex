...
\subsection{\xir}
\begin{figure}
\includegraphics[clip=true,width=\linewidth]{xi_of_r_scaling_Mr19}
\caption{OpenMP scaling for the \xir }
\end{figure}

\subsection{\xirppi}
\begin{figure}
\includegraphics[clip=true,width=\linewidth]{xi_rp_pi_scaling_Mr19}
\caption{OpenMP scaling for the \xirppi }
\end{figure}


\subsection{\wprp}
\begin{figure}
\includegraphics[clip=true,width=\linewidth]{wp_scaling_Mr19}
\caption{OpenMP scaling for the \wprp }
\end{figure}
