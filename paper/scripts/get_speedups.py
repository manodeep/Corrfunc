...
def run_wp(boxsize, x, y, z, pimax, nthreads=2, isa=None):
    import Corrfunc
    from Corrfunc.theory import wp
    from os.path import join as pjoin
    binfile = pjoin(Corrfunc.__file__, "../theory/tests", "bins")
    print("binfile = {0}".format(binfile))
    _, cell_time = wp(boxsize, pimax, nthreads, binfile,
                      x, y, z, c_cell_timer=True)
...
def main():
    ...
    all_timings = []
    for isa in all_isa:
        timings = run_wp(boxsize, x, y, z, pimax, isa=isa)
