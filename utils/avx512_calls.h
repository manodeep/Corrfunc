...
#define AVX512_BIT_COUNT_ULONGLONG(X)          __builtin_popcountll(X)
    
#else
#define AVX512_BIT_COUNT_INT(X)                _popcnt32(X)
#define AVX512_BIT_COUNT_ULONGLONG(X)          _popcnt64(X)
#endif
...
#define AVX512_MASKBIT_PATTERN              0xFFFF
...
#define AVX512_MASKBIT_PATTERN              0xFF
